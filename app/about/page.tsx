          ...
          <div className="mt-8 lg:mt-0">
            <div className="text-base max-w-prose mx-auto lg:max-w-none">
              <p className="text-lg text-gray-500 dark:text-gray-300">
                ...
                <Link href="/contact" className="underline underline-offset-2 hover:text-gray-900 dark:hover:text-gray-100 transition duration-200">
                  contact me
                </Link>
                .
              </p>
            ...
            <div className="mt-5 prose prose-blue text-lg text-gray-500 dark:text-gray-300 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
              <p>
                ...
                <Link href="https://www.bjfles.com/" className="underline underline-offset-2 hover:text-gray-900 dark:hover:text-gray-100 transition duration-200">
                ...
                <Link href="https://open.spotify.com/artist/1KmtWPNNBJw4spLrQkPrXQ?si=WThxoM2nTjKN5L06bmqVUw" className="underline underline-offset-2 hover:text-gray-900 dark:hover:text-gray-100 transition duration-200">
                  Spotify
                </Link>
                .
              </p>
              ...
              <p>
                ...
                <Link href="https://dabaz-learn.vercel.app" className="underline underline-offset-2 hover:text-gray-900 dark:hover:text-gray-100 transition duration-200">
                  DabAZ Learn
                </Link>
                {" "}- blog for learning ethical hacking and cyber security, and{" "}
                <Link href="https://dabazofficial.com" className="underline underline-offset-2 hover:text-gray-900 dark:hover:text-gray-100 transition duration-200">
                  DabLinks
                </Link>
