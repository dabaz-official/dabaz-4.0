...
function ContactForm() {
  ...
  if (state.succeeded) {
      return <div className='py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12'><p className='text-gray-900 dark:text-gray-100 text-lg'>Thanks for your message!</p></div>;
  }
        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              className="py-3 px-4 block w-full shadow-sm focus:ring-blue-500 focus:border-blue-500 border-2 border-gray-300 bg-white rounded-xl dark:border-gray-600 dark:bg-black"
            />
            <ValidationError 
              prefix="FirstName" 
              field="first-name"
